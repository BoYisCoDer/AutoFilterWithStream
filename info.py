...
API_ID = int(environ['25753788'])
API_HASH = environ['2e458859a0673fa53a046ae399b1ed99']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002185102257').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://boy:waiCsyvTpqDT9lGS@boy.d3rxb.mongodb.net/?retryWrites=true&w=majority&appName=boy")
DATABASE_NAME = environ.get('DATABASE_NAME', "boy")
...
URL = "https://nursing-rochelle-boycoder-f9c3a624.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://nursing-rochelle-boycoder-f9c3a624.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://nursing-rochelle-boycoder-f9c3a624.koyeb.app/".format(FQDN)
else:
    URL = " https://nursing-rochelle-boycoder-f9c3a624.koyeb.app/".format(FQDN)

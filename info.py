...
URL = "https://autofilterwithstream-rgi5.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilterwithstream-rgi5.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilterwithstream-rgi5.onrender.com/".format(FQDN)
else:
    URL = "https://autofilterwithstream-rgi5.onrender.com/".format(FQDN)
